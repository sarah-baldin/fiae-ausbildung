	...
	return (
		...
		<NavBar />
			<section className="impressum">
				<div className="footer-link-content col-12">
					<h2>Impressum</h2>
					...
					<p style={{"display":"block"}}>
						...
						Telefon: Meine Telefonnummer <br />
					...
					<h4>Urheberrecht</h4>
					<p>
						Die auf unserer Webseite veröffentlichen Inhalte und Werke unterliegen dem <a href="http://www.gesetze-im-internet.de/bundesrecht/urhg/gesamt.pdf">deutschen Urheberrecht</a>. Die Vervielfältigung, Bearbeitung, Verbreitung und jede Art der Verwertung des geistigen Eigentums in ideeller und materieller Sicht des Urhebers außerhalb der Grenzen des Urheberrechtes bedürfen der vorherigen schriftlichen Zustimmung des jeweiligen Urhebers i.S.d. Urhebergesetzes . Downloads und Kopien dieser Seite sind nur für den privaten und nicht kommerziellen Gebrauch erlaubt. Sind die Inhalte auf unserer Webseite nicht von uns erstellt worden, sind die Urheberrechte Dritter zu beachten. Die Inhalte Dritter werden als solche kenntlich gemacht. Sollten Sie trotzdem auf eine Urheberrechtsverletzung aufmerksam werden, bitten wir um einen entsprechenden Hinweis. Bei Bekanntwerden von Rechtsverletzungen werden wir derartige Inhalte unverzüglich entfernen.
					</p>

					<p>Dieses Impressum wurde freundlicherweise von <a href="https://jurarat.de">JuraRat</a> zur Verfügung gestellt.</p>
				</div>
			</section>
		</div>
	);
